...
const Hero = () => {
  ...
  const socialIcon = [
    { icon: <TiSocialFacebook size={28} />, link: "https://www.facebook.com/hassanahmed498" },
    {
      icon: <TiSocialLinkedin size={28} />,
      link: "https://www.linkedin.com/in/hassan-khan-b33831190/",
    },
    
    { icon: <FaWhatsapp size={28} />, link: "https://wa.me/+92 3322090197" },
  ];
  const textVariants = {
        ...
        >
          ...
          >
            ...
            <h1 className="sm:text-5xl text-5xl lg:text-6xl xl:text-7xl font-semibold">
              I am <span className="name"> Hassan Ahmed</span>
            </h1>
            ...
            >
              ...
              <a href="https://drive.google.com/file/d/129JD_Fmpiwll76UGnECs44qKuRQXU4YC/view?usp=sharing" target="_blank">
