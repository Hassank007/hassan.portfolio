                        ...
                        >
                            ...
                            <div className='flex flex-wrap gap-10 w-full my-4'>
                                <motion.div variants={statItemVariants} className='flex flex-col'>
                                    <p className='text-primary-white text-7xl font-semibold'>02+</p>
                            ...
                            <div className='flex items-center gap-10 mt-4 flex-wrap w-full'>
                                <motion.div variants={statItemVariants} className='flex flex-wrap items-center gap-1 text-secondary-text font-medium text-lg'>
                                    <p>Email:</p>
                                    <a href="mailto:hassanahmed4987427@gmail.com" className='hover:text-primary-green ease-linear duration-200 transition-all'>hassanahmed4987427@gmail.com</a>
                                </motion.div>
                                <motion.div variants={statItemVariants} className='flex flex-wrap items-center gap-1 text-secondary-text font-medium text-lg'>
                                    <p>Phone:</p>
                                    <a href="tel:(+92)123 234567" className='hover:text-primary-green ease-linear duration-200 transition-all'>+92 3322090197</a>
                                </motion.div>
                                <motion.div variants={statItemVariants} className='flex flex-wrap items-center gap-1 text-secondary-text font-medium text-lg'>
                                    <p>Location:</p>
