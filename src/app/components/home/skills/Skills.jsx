...
import mongodb from "../../../asset/logos/express.svg";
import express from "../../../asset/logos/mongodb.svg";
import nodejs from "../../../asset/logos/nodejs.svg";
...
const Skills = () => {
    ...
    const skillsData = [
        ...
        { id: 9, icon: nodejs, name: "NodeJS" },
        { id: 10, icon: express, name: "Express" },
        { id: 11, icon: mongodb, name: "MongoDB" },
        { id: 12, icon: firebase, name: "Firebase" },
        { id: 13, icon: figma, name: "Figma" },
        { id: 14, icon: photoshop, name: "Photoshop" },
        { id: 15, icon: illustrator, name: "Illustrator" },
    ];
