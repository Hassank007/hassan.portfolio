...
const Projects = () => {
    ...
    const portfolioCards = [
        { id: 1, image: img5, link: "https://kayo-template.webflow.io/", github:"https://github.com/Hassank007" },
        { id: 2, image: img2, link: "https://sprring-free.webflow.io/",  github:"https://github.com/Hassank007" },
        { id: 3, image: img3, link: "https://sita00.vercel.app/",   github:"https://github.com/Hassank007"},
        { id: 4, image: img4, link: "https://restaurant-rust-eight.vercel.app/",  github:"https://github.com/Hassank007" },
        { id: 5, image: img1, link: "https://captifylive.online/",  github:"https://github.com/Hassank007" },
        { id: 6, image: img6, link: "https://mad-two.vercel.app/step-bodytype",  github:"https://github.com/Hassank007" },
        { id: 7, image: img7, link: "https://socialreachpro.vercel.app/",  github:"https://github.com/Hassank007" },
        { id: 8, image: img8, link: "https://cicada-azure.vercel.app/",  github:"https://github.com/Hassank007" },
                        ...
                        {visibleCards.map((e, index) => (
                            ...
                            >
                                ...
                                <div className="flex items-center bg-gradient-to-t h-[50%] from-black via-black/50 to-transparent justify-center w-full gap-5 translate-y-56 group-hover:-translate-y-40 ease-linear transition-all duration-300">
                                    <button onClick={() => window.open(e.github, '_blank')} className="bg-primary-gray border border-primary-white/20  text-white hover:scale-110 ease-in-out duration-150 transition-all  rounded-xl w-14 h-14 flex justify-center items-center">
                                        <FaGithub size={25} />
                                    </button>
